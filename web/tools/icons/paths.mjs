...
export const GLYPHS = {
  ...
  settings: 'M12 16.4a4.4 4.4 0 1 0 0-8.8 4.4 4.4 0 0 0 0 8.8zM12 3.4l1.5 2.6 3-.6 1.1 2.8 3 .8-1 2.9 2.2 2.2-2.2 2.2 1 2.9-3 .8-1.1 2.8-3-.6-1.5 2.6-1.5-2.6-3 .6-1.1-2.8-3-.8 1-2.9L.8 12l2.2-2.2-1-2.9 3-.8 1.1-2.8 3 .6z',
};
